...
public class Application {
    ...
    private static void trimSubMenu() {
        ...
        do {
            ...
            System.out.println("2. 메뉴 혹은 카테고리코드로 검색, 단 메뉴와 카테고리 둘 다 일치하는 경우도 검색," +
                    " 검색 조건 없으면 전체 검색");
    ...
    private static void foreachSubMenu() {
        ...
        do {
            ...
            switch (no) {
                case 1 :
                    menuService.seachMenuByRandomCode(createRandomCodeList());
                break;
                case 9 :
                    return;
    ...
    private static List<Integer> createRandomCodeList() {
        ...
        while (set.size() < 5) {
            // 내 컴퓨터에 들어있는 메뉴 갯수 24개 + 시작값 1 이라는 뜻
